...
def MinHashNumpy(docsAsShingleSets):
    ...
    signatures = []
    check_for_minHash_file = os.path.isfile('./Minhash_Data.json')
    if (check_for_minHash_file):
        print ("\nRecovering MinHash data from file\n")
        with open('Minhash_Data.json', 'r') as jfile:
        ...
        with open('Minhash_Data.json', 'w') as jfile:
