...
# =============================================================================
def setTracesMinHashSignatures(traces):
	...
	for i in range(0, numDocs):
		...
		traceShingleSet = traces[i].get_shingles()
		...
		for j in range(0, settings.numHashes):
			...
			for shingleID in traceShingleSet:
		...
		traces[i].set_signature(signature)
		# TEMP # print('Doc index ['+ str(i) +'] signatures:' + str(signature))
